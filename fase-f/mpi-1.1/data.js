...
var DATA = {
  ...
  eksplorasi: {
    ...
    instruction: 'Tekan tombol untuk mengungkap suku berikutnya. Amati pola yang terbentuk, lalu tentukan suku pertama (a) dan beda (b).',
    konteks: [
      {
        id: 'ctx1',
        badge: 'Kursi Bioskop',
        story: 'Sebuah bioskop memiliki kursi yang bertambah secara teratur di setiap barisnya. Baris ke-1 memiliki 8 kursi, baris ke-2 memiliki 13 kursi, dan seterusnya.',
        icon: '🎬',
      ...
      },
      {
        id: 'ctx2',
        badge: 'Biaya Hosting',
        story: 'Tim pengembang RPL menyewa server cloud. Bulan pertama biayanya Rp 200.000. Setiap bulan biaya bertambah Rp 50.000 karena kapasitas ditingkatkan.',
        icon: '☁️',
      ...
      },
      {
        id: 'ctx3',
        badge: 'Commit GitHub',
        story: 'Rahel sedang belajar Git. Minggu pertama ia membuat 3 commit, minggu kedua 7 commit, dan seterusnya — bertambah secara teratur.',
        icon: '💻',
  ...
  rumusUn: {
    ...
    steps: [
      {
        id: 's1',
        question: 'Perhatikan kolom "Bentuk Umum". Berapa kali <strong>b</strong> ditambahkan untuk mendapatkan suku ke-4?',
        answer: '3',
        hint: 'U₄ = a + ?×b. Lihat polanya: U₁ tidak ada b, U₂ ada 1b, U₃ ada 2b, U₄ ada...?',
        explanation: 'Untuk suku ke-4, b ditambahkan sebanyak 3 kali: U₄ = a + 3b. Polanya: Uₙ = a + (n−1)b.'
      },
      {
        id: 's2',
        ...
        explanation: 'U₁₀ = 3 + (10−1)×4 = 3 + 9×4 = 3 + 36 = 39. Rahel membuat 39 commit di minggu ke-10.'
      }
    ]
  },
  ...
  latihanUn: {
    ...
    soal: [
      ...
      },
      {
        ...
        explanation: 'U₈ = 50 + (8−1)×(−4) = 50 + (−28) = <strong>22</strong>. Beda negatif → barisan menurun.'
      },
      {
        id: 'u3',
        ...
        explanation: 'U₁₂ = 200 + (12−1)×50 = 200 + 550 = <strong>750</strong> (ribu rupiah). Biaya bulan ke-12 adalah Rp 750.000.'
      },
      {
        id: 'u4',
        konteks: null,
      ...
      {
        id: 'u5',
        konteks: 'Dika menulis laporan magang. Hari pertama ia menulis 15 baris kode, setiap hari bertambah 8 baris.',
        ...
        explanation: 'U₁₅ = 15 + (15−1)×8 = 15 + 14×8 = 15 + 112 = <strong>127</strong> baris kode.'
      },
      {
        id: 'u6',
        konteks: null,
        ...
        explanation: '55 = 100 + (n−1)×(−5) → −45 = (n−1)×(−5) → n−1 = 9 → n = <strong>10</strong>. Jadi U₁₀ = 55.'
      }
    ]
  },
  ...
  ekspSn: {
    ...
    instruction: 'Kita akan menemukan rumus Sₙ dengan trik yang digunakan matematikawan Carl Friedrich Gauss.',
    ...
    gaussQuestion: {
      question: 'Perhatikan: 34 = 3 + 31 = a + U₈ = a + Uₙ. Jadi 2Sₙ = n × (a + Uₙ). Karena Uₙ = a + (n−1)b, maka:',
      formula: 'Sₙ = n/2 × (2a + (n−1)b)',
      alt: 'atau: Sₙ = n/2 × (a + Uₙ)'
    },
    verifikasi: {
      question: 'Verifikasi: Gunakan rumus untuk menghitung S₈ pada barisan di atas (a=3, b=4, n=8).',
      answer: 136,
      hint: 'S₈ = 8/2 × (2×3 + (8−1)×4) = 4 × (6 + 28) = 4 × 34 = ?',
      explanation: 'S₈ = 8/2 × (2×3 + 7×4) = 4 × (6 + 28) = 4 × 34 = <strong>136</strong>. ✓ Sesuai dengan cara langsung!'
    }
  },
  ...
  latihanSn: {
    ...
    soal: [
      ...
      },
      {
        ...
        explanation: 'S₁₅ = 15/2 × (2×4 + 14×4) = 7,5 × (8 + 56) = 7,5 × 64 = <strong>480</strong>.'
      },
      {
        id: 's3',
        barisan_display: '100, 95, 90, 85, ...',
        ...
        explanation: 'S₁₀ = 10/2 × (200 + 9×(−5)) = 5 × (200 − 45) = 5 × 155 = <strong>775</strong>.'
      },
      {
        id: 's4',
      ...
      },
      {
        ...
        question: 'Tentukan jumlah 20 bilangan ganjil pertama: <strong>S₂₀</strong> dari 1, 3, 5, 7, ...',
        a: 1, b: 2, n: 20,
        answer: 400,
        hints: [
        ...
        explanation: 'S₂₀ = 20/2 × (2 + 19×2) = 10 × (2 + 38) = 10 × 40 = <strong>400</strong>. Menarik: jumlah n bilangan ganjil pertama selalu = n²!'
      },
      {
        id: 's6',
    ...
    soal: [
      {
        ...
        icon: '📱',
        story: 'Platform streaming populer menaikkan harga langganannya setiap bulan. Bulan pertama harganya <strong>Rp 50.000</strong>. Setiap bulan harga naik <strong>Rp 5.000</strong>.',
      ...
      },
      {
        ...
        icon: '💾',
        story: 'Kapasitas server tim RPL bertambah <strong>20 GB</strong> setiap bulan. Kapasitas awal di bulan pertama adalah <strong>100 GB</strong>.',
        question: 'Berapa <strong>total kapasitas</strong> yang digunakan selama <strong>10 bulan</strong> pertama?',
        type: 'input',
        answer: 1900,
        unit: 'GB',
        hint: 'Ini adalah masalah deret aritmetika (jumlah kapasitas 10 bulan). a = 100, b = 20, n = 10. Gunakan Sₙ = n/2 × (2a + (n−1)b).',
        explanation: 'S₁₀ = 10/2 × (2×100 + 9×20) = 5 × (200 + 180) = 5 × 380 = <strong>1.900 GB</strong>.'
      },
      {
        id: 't3',
        badge: 'Gaji Magang',
        icon: '💼',
        story: 'Dika magang di perusahaan teknologi selama 6 bulan. Gaji bulan pertamanya <strong>Rp 1.200.000</strong> dan setiap bulan naik <strong>Rp 150.000</strong>.',
        ...
        explanation: 'S₆ = 6/2 × (2×1.200.000 + 5×150.000) = 3 × (2.400.000 + 750.000) = 3 × 3.150.000 = <strong>Rp 9.450.000</strong>.'
      },
      {
        id: 't4',
        badge: 'Bug Report',
        icon: '🐛',
        story: 'Tim QA mencatat jumlah bug yang ditemukan per sprint. Sprint ke-1 ada <strong>25 bug</strong>, dan setiap sprint berkurang <strong>3 bug</strong> (tim makin mahir!).',
        ...
        explanation: '7 = 25 + (n−1)×(−3) → −18 = (n−1)×(−3) → n−1 = 6 → n = <strong>7</strong>. Jadi pada sprint ke-7, jumlah bug menjadi 7.'
      }
    ]
  },
  ...
  refleksi: {
    ...
    soal: [
      {
        id: 'r1',
        question: 'Dengan kata-katamu sendiri, jelaskan apa yang dimaksud dengan <strong>barisan aritmetika</strong> dan apa itu <strong>beda (b)</strong>.',
        placeholder: 'Tuliskan penjelasanmu...'
      },
      {
        id: 'r2',
        question: 'Bagaimana kamu mengingat rumus <strong>Uₙ = a + (n−1)b</strong>? Strategi apa yang kamu pakai?',
        placeholder: 'Ceritakan strategimu...'
      },
      {
        id: 'r3',
        question: 'Berikan satu contoh <strong>barisan aritmetika</strong> dari kehidupan sehari-hari sebagai pelajar SMK RPL yang belum disebutkan dalam media ini.',
        placeholder: 'Contohmu...'
      },
      {
        id: 'r4',
        question: 'Hal apa yang masih membingungkan atau ingin kamu pelajari lebih lanjut tentang barisan dan deret?',
