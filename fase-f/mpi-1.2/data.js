...
var DATA = {
  ...
  eksplorasi: {
    ...
    instruction:
      'Tekan tombol untuk mengungkap suku berikutnya. Amati pola yang terbentuk, lalu tentukan suku pertama (a) dan rasio (r).',
    konteks: [
      {
        id: 'ctx1',
        badge: 'Pertumbuhan Pengguna App',
        story:
          'Tim RPL meluncurkan aplikasi dan memantau pertumbuhan pengguna. Bulan pertama ada 500 pengguna. Setiap bulan jumlah pengguna menjadi dua kali lipat.',
        icon: '🚀',
        ...
        hint_r:
          'Hitung rasio: Suku ke-2 ÷ Suku ke-1 = 1.000 ÷ 500 = ? Coba cek juga Suku ke-3 ÷ Suku ke-2.',
      },
      {
        id: 'ctx2',
        badge: 'Nilai Investasi',
        story:
          'Rika menginvestasikan uang tabungan di reksa dana. Nilai investasi awalnya Rp 100.000. Setiap tahun nilainya menjadi tiga kali lipat karena return investasi yang tinggi.',
        icon: '💰',
        ...
        hint_r:
          'Hitung rasio: Nilai tahun ke-2 ÷ Nilai tahun ke-1 = 300 ÷ 100 = ? Cek konsistensinya!',
      },
      {
        id: 'ctx3',
        badge: 'Kapasitas Server',
        story:
          'Tim DevOps memulai dengan server berkapasitas 2 GB. Setiap kali upgrade perangkat keras, kapasitas penyimpanan menjadi dua kali lipat.',
        icon: '💾',
    ...
    steps: [
      {
        id: 's1',
        question:
          'Perhatikan kolom "Bentuk Umum". Berapa pangkat <strong>r</strong> pada suku ke-4?',
        answer: '3',
        hint: 'U₄ = a × r^?. Lihat polanya: U₁ ada r⁰, U₂ ada r¹, U₃ ada r², U₄ ada...?',
        explanation:
          'Untuk suku ke-4, r berpangkat 3: U₄ = a × r³. Polanya: Uₙ = a × rⁿ⁻¹ — pangkat r selalu satu kurang dari nomor sukunya.',
      },
      {
        id: 's2',
  ...
  latihanUn: {
    ...
    soal: [
      ...
      },
      {
        ...
        explanation:
          'U₆ = 96 × (1/2)⁵ = 96 ÷ 32 = <strong>3</strong>. Barisan geometri bisa menurun jika rasio 0 < r < 1.',
      },
      {
        id: 'u4',
        konteks:
          'Malware menginfeksi 4 komputer pada hari pertama. Setiap hari jumlah infeksi baru menjadi tiga kali lipat.',
        ...
        explanation:
          'U₅ = 4 × 3⁴ = 4 × 81 = <strong>324</strong> komputer terinfeksi di hari ke-5.',
      },
      {
        id: 'u5',
        konteks: null,
        ...
        explanation:
          '96 = 3 × 2^(n−1) → 32 = 2^(n−1) → n−1 = 5 → n = <strong>6</strong>. Jadi U₆ = 96.',
      },
      {
        id: 'u6',
        konteks: null,
  ...
  ekspSn: {
    ...
    verifikasi: {
      question:
        'Verifikasi: Gunakan rumus untuk menghitung S₄ pada barisan 3, 6, 12, 24 (a=3, r=2, n=4).',
      answer: 45,
      hint: 'S₄ = 3 × (2⁴ − 1) ÷ (2 − 1) = 3 × (16 − 1) ÷ 1 = 3 × 15 = ?',
      explanation:
        'S₄ = 3(2⁴ − 1)/(2 − 1) = 3 × 15 / 1 = <strong>45</strong>. ✓ Cocok: 3 + 6 + 12 + 24 = 45.',
    },
  },
    ...
    soal: [
      {
        ...
        icon: '💹',
        story:
          'Ardi menginvestasikan <strong>Rp 5.000.000</strong> di reksa dana saham. Setiap tahun nilai investasinya berlipat <strong>dua kali</strong>.',
        ...
        explanation:
          'U₆ = 5 × 2⁵ = 5 × 32 = <strong>160 juta rupiah</strong>. Investasi yang tumbuh eksponensial!',
      },
      {
        id: 't2',
        ...
        icon: '🦠',
        story:
          'Sebuah malware menginfeksi <strong>1 komputer</strong> pada hari pertama. Setiap hari, setiap komputer yang terinfeksi menyebarkan ke komputer lain sehingga total komputer terinfeksi menjadi <strong>tiga kali lipat</strong>.',
        question:
          'Berapa <strong>total</strong> komputer yang telah terinfeksi setelah <strong>5 hari</strong>?',
        type: 'input',
        answer: 121,
        unit: 'komputer',
        hint: 'Ini adalah jumlah deret geometri. a = 1, r = 3, n = 5. Gunakan Sₙ = a(rⁿ − 1)/(r − 1).',
        explanation:
          'S₅ = 1 × (3⁵ − 1) / (3 − 1) = (243 − 1) / 2 = 242 / 2 = <strong>121 komputer</strong>.',
      },
      {
        id: 't3',
        ...
        icon: '📱',
        story:
          'Aplikasi buatan tim RPL diluncurkan dengan <strong>100 pengguna</strong> awal. Berkat strategi pemasaran digital, setiap bulan jumlah pengguna menjadi <strong>dua kali lipat</strong>.',
        question:
          'Pada bulan ke berapa jumlah pengguna <strong>pertama kali mencapai 3.200</strong>?',
        type: 'choice',
        options: [
        ...
        explanation:
          '3200 = 100 × 2^(n−1) → 32 = 2^(n−1) → 2⁵ = 2^(n−1) → n−1 = 5 → n = <strong>6</strong>. Bulan ke-6!',
      },
      {
        id: 't4',
        ...
        icon: '⚡',
        story:
          'Tim DevOps memiliki server dengan kapasitas awal <strong>8 GB</strong>. Setiap kali upgrade, kapasitas server menjadi <strong>tiga kali lipat</strong>. Mereka melakukan upgrade sebanyak 3 kali (total ada 4 generasi server).',
        ...
        explanation:
          'S₄ = 8 × (3⁴ − 1) / (3 − 1) = 8 × (81 − 1) / 2 = 8 × 80 / 2 = 8 × 40 = <strong>320 GB</strong>.',
      },
    ],
  },
    ...
    soal: [
      {
        id: 'r1',
        question:
          'Dengan kata-katamu sendiri, apa perbedaan antara <strong>barisan aritmetika</strong> dan <strong>barisan geometri</strong>? Apa yang membedakan cara menghitung sukunya?',
        placeholder: 'Tuliskan penjelasanmu...',
      },
      {
        id: 'r2',
        question:
          'Bagaimana kamu mengingat rumus <strong>Uₙ = a × rⁿ⁻¹</strong>? Strategi apa yang membantumu?',
        placeholder: 'Ceritakan strategimu...',
      },
      {
        id: 'r3',
        question:
          'Berikan satu contoh <strong>barisan geometri</strong> dari kehidupan sehari-hari sebagai pelajar SMK RPL yang belum disebutkan dalam media ini.',
        placeholder: 'Contohmu...',
      },
      {
        id: 'r4',
        question:
          'Hal apa yang masih membingungkan atau ingin kamu pelajari lebih lanjut tentang barisan dan deret geometri?',
