...
var DATA = {
  ...
  eksplorasiBT: {
    ...
    instruction: 'Tekan tombol untuk mengungkap nilai uang di setiap akhir tahun. Amati pola kenaikannya, lalu identifikasi suku pertama (a) dan kenaikan tetap (b).',
    konteks: [
      {
        id: 'bt1',
        badge: 'Tabungan Koperasi',
        icon: '🏫',
        story: 'Fauzan menyimpan <strong>Rp 1.000.000</strong> di koperasi sekolah. Koperasi memberi <strong>bunga tunggal 10% per tahun</strong> — dihitung selalu dari modal awal, bukan dari saldo.',
        ...
        hint_b: 'Bunga per tahun = 10% × Rp 1.000.000 = Rp 100.000 (selalu sama karena dihitung dari modal awal!).'
      },
      {
        id: 'bt2',
        badge: 'Pinjaman Usaha',
        icon: '🏪',
        story: 'Ibu Rani meminjam <strong>Rp 2.000.000</strong> untuk modal warung dengan <strong>bunga tunggal 5% per tahun</strong> dari pokok pinjaman awal.',
  ...
  rumusBT: {
    ...
    instruction: 'Amati tabel pola di bawah ini untuk menemukan rumus Mₙ = M₀(1 + n·i), lalu hubungkan dengan rumus barisan aritmetika.',
    modal: 1000000,
    bunga_persen: 10,
    beda: 100000,
    ...
    steps: [
      {
        id: 'bt_s1',
        question: 'Lanjutkan pola tabel. Berapa nilai <strong>M₅</strong> (tabungan di akhir tahun ke-5)?',
        answer: '1500000',
        hint: 'M₅ = M₀ + 5×(M₀×i) = 1.000.000 + 5×100.000 = 1.000.000 + 500.000 = ?',
        explanation: 'M₅ = 1.000.000 + 5×100.000 = <strong>Rp 1.500.000</strong>. Tiap tahun naik Rp 100.000 — ini adalah beda (b) dalam barisan aritmetika!'
      },
      {
        id: 'bt_s2',
        question: 'Gunakan rumus Mₙ = M₀(1 + n·i). Berapa nilai <strong>M₈</strong> (tabungan di akhir tahun ke-8)?',
        answer: '1800000',
        hint: 'M₈ = 1.000.000 × (1 + 8 × 0,10) = 1.000.000 × (1 + 0,8) = 1.000.000 × 1,8 = ?',
        explanation: 'M₈ = 1.000.000 × (1 + 8×0,10) = 1.000.000 × 1,8 = <strong>Rp 1.800.000</strong>.'
      }
    ],
    koneksiArtimatika: {
  ...
  eksplorasiBM: {
    ...
    instruction: 'Tekan tombol untuk mengungkap nilai di setiap periode. Amati pola rasionya, lalu identifikasi suku pertama (a) dan rasio (r).',
    konteks: [
      {
        id: 'bm1',
        badge: 'Pertumbuhan Pengguna App',
        icon: '📱',
        story: 'Tim RPL meluncurkan aplikasi mobile. Bulan ke-0 ada <strong>500 pengguna</strong>. Setiap bulan jumlah pengguna berlipat dua — ini mencerminkan <strong>bunga majemuk 100% per bulan</strong> (r = 2).',
      ...
      },
      {
        ...
        icon: '🔥',
        story: 'Video tutorial RPL menjadi viral. Jam ke-0 ditonton <strong>50 orang</strong>. Setiap jam jumlah penonton menjadi <strong>3 kali lipat</strong> — ini mencerminkan bunga majemuk dengan r = 3.',
  ...
  rumusBM: {
    ...
    instruction: 'Amati tabel pola di bawah ini untuk menemukan rumus Mₙ = M₀ × rⁿ, lalu hubungkan dengan rumus barisan geometri.',
    modal: 500,
    rasio: 2,
    ...
    steps: [
      {
        id: 'bm_s1',
        question: 'Lanjutkan pola tabel. Berapa nilai <strong>M₅</strong> (pengguna di bulan ke-5)?',
        answer: '16000',
        hint: 'M₅ = 500 × 2⁵ = 500 × 32 = ?',
        explanation: 'M₅ = 500 × 2⁵ = 500 × 32 = <strong>16.000 pengguna</strong>. Bandingkan dengan bunga tunggal — pertumbuhannya jauh lebih cepat!'
      },
      {
        id: 'bm_s2',
        question: 'Gunakan rumus Mₙ = M₀ × rⁿ. Berapa nilai <strong>M₇</strong> (pengguna di bulan ke-7)?',
        answer: '64000',
        hint: 'M₇ = 500 × 2⁷ = 500 × 128 = ?',
        explanation: 'M₇ = 500 × 2⁷ = 500 × 128 = <strong>64.000 pengguna</strong>. Pertumbuhan eksponensial!'
      }
    ],
    koneksiGeometri: {
  ...
  perbandingan: {
    ...
    instruction: 'Amati perbedaan pertumbuhan uang antara bunga tunggal (aritmetika) dan bunga majemuk (geometri) untuk modal dan suku bunga yang sama.',
    contohModal: 1000000,
    contohBunga: 10,
    tableData: [
  ...
  latihan: {
    ...
    instruction: 'Kerjakan soal-soal berikut. Gunakan rumus yang sesuai — Mₙ = M₀(1+n·i) untuk BT, dan Mₙ = M₀·rⁿ untuk BM.',
    soal: [
      {
        id: 'l1',
        tipe: 'bt',
        ...
        explanation: 'M₆ = 4.000.000 × (1 + 6×0,05) = 4.000.000 × 1,3 = <strong>Rp 5.200.000</strong>.'
      },
      {
        id: 'l2',
        tipe: 'bt',
        ...
        explanation: 'b = 2.500.000 × 0,08 = <strong>Rp 200.000</strong>. Setiap tahun nilai pinjaman bertambah Rp 200.000.'
      },
      {
        id: 'l3',
        tipe: 'bm',
        tipeBadge: 'Bunga Majemuk',
        konteks: 'Sebuah startup mendapat investasi awal Rp 500 juta. Nilai investasi berlipat dua setiap tahun (r = 2).',
        ...
        explanation: 'M₅ = 500 × 2⁵ = 500 × 32 = <strong>16.000 juta rupiah</strong> (Rp 16 miliar)!'
      },
      {
        id: 'l4',
        tipe: 'bm',
        ...
        explanation: 'M₂ = 1.000.000 × (1,10)² = 1.000.000 × 1,21 = <strong>Rp 1.210.000</strong>. Berbeda dengan BT yang hanya Rp 1.200.000!'
      },
      {
        id: 'l5',
        tipe: 'identifikasi',
        ...
        konteks: null,
        question: 'Seorang nasabah mencatat nilai tabungannya: <strong>500.000 → 600.000 → 720.000 → 864.000</strong>. Termasuk jenis bunga apa?',
        type: 'choice',
        options: [
        ...
        explanation: 'Rasio: 600÷500 = 720÷600 = 864÷720 = <strong>1,2</strong> (konstan). Ini barisan <strong>geometri → Bunga Majemuk</strong> dengan r = 1,2 (i = 20% per periode).'
      },
      {
        id: 'l6',
        tipe: 'identifikasi',
        ...
        konteks: null,
        question: 'Raka memiliki dua pilihan tabungan selama 3 tahun, modal Rp 10.000.000, bunga 20%/tahun. Mana yang menghasilkan lebih banyak?',
        type: 'choice',
        options: [
        ...
        explanation: 'BT: 10.000.000 × 1,6 = <strong>Rp 16.000.000</strong>. BM: 10.000.000 × 1,728 = <strong>Rp 17.280.000</strong>. Pilihan B (<strong>Bunga Majemuk</strong>) lebih menguntungkan!'
      }
    ]
  },
  ...
  refleksi: {
    ...
    soal: [
      {
        id: 'r1',
        question: 'Dengan kata-katamu sendiri, jelaskan <strong>perbedaan mendasar</strong> antara cara menghitung bunga tunggal dan bunga majemuk.',
        placeholder: 'Tuliskan penjelasanmu...'
      },
      {
        id: 'r2',
        question: 'Mengapa bunga tunggal berkaitan dengan <strong>barisan aritmetika</strong>? Apa yang menjadi "beda (b)"-nya?',
        placeholder: 'Ceritakan pemahamanmu...'
      },
      {
        id: 'r3',
        question: 'Mengapa bunga majemuk berkaitan dengan <strong>barisan geometri</strong>? Apa yang menjadi "rasio (r)"-nya?',
        placeholder: 'Ceritakan pemahamanmu...'
      },
      {
        id: 'r4',
        question: 'Sebagai calon pengembang aplikasi fintech, kapan kamu akan menggunakan rumus bunga tunggal dan kapan bunga majemuk? Berikan contoh fitur aplikasinya.',
