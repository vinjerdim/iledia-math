  ...
  container.innerHTML =
    ...
    buildDlPanel(
      '<div class="summary-grid">' +
        kartu(
          countCorrect(State.latihSStates) + '/' + DATA.latihSederhana.soal.length,
          'Latihan menyederhanakan benar'
        ) +
        kartu(
          countCorrect(State.latihMStates) + '/' + DATA.latihSamakan.soal.length,
          'Latihan menyamakan penyebut benar'
        ) +
        kartu(
