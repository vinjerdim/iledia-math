  ...
  kenaliBulat: {
    ...
    konteks: [
        ...
        items: [
          {
            label: "Puncak (malam)",
            value: -5,
            note: "5 derajat di bawah nol",
            color: "blue",
          },
          {
            label: "Dieng Plateau",
            value: -2,
            note: "2 derajat di bawah nol",
            color: "blue",
          },
          {
            label: "Titik Beku Air",
            value: 0,
            note: "Titik nol (batas)",
            color: "neutral",
          },
          {
            label: "Bandung",
            value: 18,
            note: "18 derajat di atas nol",
            color: "orange",
          },
          {
            label: "Jakarta",
            value: 32,
            note: "32 derajat di atas nol",
            color: "orange",
          },
        ],
        unit: "°C",
      ...
      },
      {
        ...
        items: [
          {
            label: "Basement 2 (Parkir)",
            value: -2,
            note: "Dua lantai di bawah tanah",
            color: "blue",
          },
          {
            label: "Basement 1 (Parkir)",
            value: -1,
            note: "Satu lantai di bawah tanah",
            color: "blue",
          },
          {
            label: "Lantai Dasar",
            value: 0,
            note: "Pintu masuk utama",
            color: "neutral",
          },
          {
            label: "Lantai 1 (Fashion)",
            value: 1,
            note: "Satu lantai di atas tanah",
            color: "orange",
          },
          {
            label: "Lantai 2 (Food Court)",
            value: 2,
            note: "Dua lantai di atas tanah",
            color: "orange",
          },
        ],
        unit: "",
      ...
      },
      {
        ...
        items: [
          {
            label: "Salah 2× berturut",
            value: -10,
            note: "2 jawaban salah",
            color: "blue",
          },
          {
            label: "Salah 1×",
            value: -5,
            note: "1 jawaban salah",
            color: "blue",
          },
          {
            label: "Dilewati",
            value: 0,
            note: "Tidak ada perubahan skor",
            color: "neutral",
          },
          {
            label: "Benar 1×",
            value: 10,
            note: "1 jawaban benar",
            color: "orange",
          },
          {
            label: "Benar 3× berturut",
            value: 30,
            note: "3 jawaban benar",
            color: "orange",
          },
        ],
        unit: "poin",
    ...
    soal: [
      {
        ...
        explanation:
          "Titik itu berada 7 langkah di sebelah kiri nol, sehingga nilainya adalah −7.",
      },
      {
        id: "gb2",
        nilai: 4,
        ...
        explanation:
          "Titik itu berada 4 langkah di sebelah kanan nol, sehingga nilainya adalah 4.",
      },
      {
        id: "gb3",
        nilai: -3,
        ...
        explanation:
          "Titik itu berada 3 langkah di sebelah kiri nol, sehingga nilainya adalah −3.",
      },
      {
        id: "gb4",
        nilai: 0,
      ...
      },
      {
        ...
        explanation:
          "Titik itu berada 8 langkah di sebelah kanan nol, sehingga nilainya adalah 8.",
      },
      {
        id: "gb6",
        nilai: -10,
  ...
  membandingkan: {
    ...
    soal: [
      ...
      },
      {
        ...
        explanation:
          "5 = 5. Kedua bilangan positif ini memiliki nilai yang sama.",
      },
      {
        id: "mb8",
        a: -1,
  ...
  situasiNyata: {
    ...
    soal: [
      ...
      },
      {
        ...
        question:
          "Manakah urutan lantai yang benar dari posisi terendah ke tertinggi?",
        type: "choice",
        options: [
        ...
        options: [
          {
            id: "opt_a",
            label:
              "Andi, karena +250.000 > −300.000 (saldo positif lebih baik dari negatif)",
          },
          {
            id: "opt_b",
