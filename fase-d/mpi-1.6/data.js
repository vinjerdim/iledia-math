...
const DATA = {
    ...
    pembulatan: {
        ...
        instruction: 'Tentukan hasil pembulatan harga setiap barang sesuai instruksi. Pilih satu jawaban yang benar.',
        soal: [
            /* --- Pembulatan ke ribuan (Rp1.000) terdekat --- */
            {
                ...
                explanation: 'Angka ratusan pada Rp24.750 adalah 7 (≥ 5), sehingga dibulatkan ke atas ke ribuan berikutnya → Rp25.000.'
            },
            {
                id: 'p2',
                harga: 8350,
                ...
                explanation: 'Angka ratusan pada Rp8.350 adalah 3 (< 5), sehingga dibulatkan ke bawah → Rp8.000.'
            },
            {
                id: 'p3',
                harga: 17490,
                ...
                explanation: 'Angka ratusan pada Rp17.490 adalah 4 (< 5), sehingga dibulatkan ke bawah → Rp17.000.'
            },
            {
                id: 'p4',
                harga: 12650,
                ...
                explanation: 'Angka ratusan pada Rp12.650 adalah 6 (≥ 5), sehingga dibulatkan ke atas → Rp13.000.'
            },
            /* --- Pembulatan ke lima ribuan (Rp5.000) terdekat --- */
            {
                ...
                explanation: '|Rp34.200 − Rp30.000| = Rp4.200, sedangkan |Rp34.200 − Rp35.000| = Rp800. Karena lebih dekat ke Rp35.000, dibulatkan ke atas → Rp35.000.'
            },
            {
                id: 'p6',
                harga: 22800,
                ...
                explanation: '|Rp22.800 − Rp20.000| = Rp2.800, sedangkan |Rp22.800 − Rp25.000| = Rp2.200. Karena lebih dekat ke Rp25.000, dibulatkan ke atas → Rp25.000.'
            },
            /* --- Pembulatan ke sepuluh ribuan (Rp10.000) terdekat --- */
            {
                ...
                explanation: 'Angka ribuan pada Rp46.400 adalah 6 (≥ 5), sehingga dibulatkan ke atas → Rp50.000.'
            },
            {
                id: 'p8',
                harga: 73100,
                ...
                explanation: 'Angka ribuan pada Rp73.100 adalah 3 (< 5), sehingga dibulatkan ke bawah → Rp70.000.'
            }
        ]
    },
        ...
        challenges: [
            {
                id: 'c1',
                label: 'Tantangan 1',
                context: 'Kamu memiliki uang Rp50.000 untuk membeli alat tulis sekolah. Pilih barang-barang yang menurutmu masih sesuai anggaran.',
                budget: 50000,
                minSelect: 2,
                items: [
            ...
            },
            {
                id: 'c2',
                label: 'Tantangan 2',
                context: 'Kamu membawa uang Rp35.000 untuk membeli camilan. Pilih barang yang sesuai anggaran.',
                budget: 35000,
                minSelect: 2,
                items: [
            ...
            },
            {
                id: 'c3',
                label: 'Tantangan 3',
                context: 'Kamu memiliki uang Rp80.000 untuk membeli perlengkapan piknik. Pilih barang yang sesuai anggaran.',
                budget: 80000,
                minSelect: 3,
                items: [
    ...
    asesmen: {
        ...
        instruction: 'Jawab setiap pertanyaan dengan memilih satu jawaban yang paling tepat. Feedback akan ditampilkan setelah jawaban dikunci.',
        soal: [
            {
                id: 'a1',
                pertanyaan: 'Seorang siswa ingin memastikan uangnya cukup sebelum ke kasir. Strategi pembulatan mana yang paling aman?',
                pilihan: [
                    { id: 'a', teks: 'Bulatkan semua harga ke bawah agar estimasi total lebih kecil dari harga sebenarnya.' },
                    { id: 'b', teks: 'Bulatkan semua harga ke atas agar estimasi total lebih besar dari harga sebenarnya.' },
                ...
                correct: 'b',
                explanation: 'Membulatkan ke atas (overestimation) lebih aman jika tujuanmu memastikan uang cukup. Estimasimu akan selalu lebih besar dari total sebenarnya, sehingga kamu tidak akan kekurangan uang di kasir. Perlu diingat: pembulatan ke atas yang terlalu besar dapat menyebabkan estimasi yang jauh meleset dan malah salah dalam mengambil keputusan.'
            },
            {
                id: 'a2',
                ...
                correct: 'a',
                explanation: 'Angka ratusan pada Rp13.450 adalah 4. Karena 4 < 5, dibulatkan ke bawah → Rp13.000. Aturan dasar: jika digit yang diperhatikan kurang dari 5, bulatkan ke bawah; jika 5 atau lebih, bulatkan ke atas.'
            },
            {
                id: 'a3',
                pertanyaan: 'Budi menganggarkan Rp60.000. Estimasinya Rp58.000, tetapi total sebenarnya ternyata Rp61.500. Apa simpulannya?',
                pilihan: [
                ...
                correct: 'c',
                explanation: 'Estimasi Budi (Rp58.000) lebih rendah dari total sebenarnya (Rp61.500) → underestimation. Karena total sebenarnya (Rp61.500) melebihi anggaran (Rp60.000), Budi kekurangan uang Rp1.500. Ini menunjukkan risiko membulatkan ke bawah ketika anggaran sangat ketat.'
            },
            {
                id: 'a4',
                pertanyaan: 'Kapan estimasi lebih tepat digunakan daripada perhitungan presisi?',
                pilihan: [
                    { id: 'a', teks: 'Saat ingin mengetahui kembalian yang tepat setelah membayar di kasir.' },
                    { id: 'b', teks: 'Saat perlu memperkirakan dengan cepat apakah uang cukup sebelum memilih barang.' },
                    { id: 'c', teks: 'Saat kasir menghitung total harga menggunakan mesin kasir.' },
                    { id: 'd', teks: 'Saat mengisi laporan keuangan resmi sekolah.' }
                ],
                correct: 'b',
                explanation: 'Estimasi paling berguna untuk pengambilan keputusan cepat, seperti memperkirakan apakah uangmu cukup sebelum ke kasir. Untuk mengetahui kembalian tepat, laporan keuangan, atau perhitungan kasir, diperlukan perhitungan presisi.'
            },
            {
                id: 'a5',
                pertanyaan: 'Ani membulatkan tiga harga ke sepuluh ribuan terdekat: Rp23.800, Rp11.500, dan Rp38.200. Berapa total estimasinya?',
                pilihan: [
                ...
                correct: 'a',
                explanation: 'Rp23.800 → angka ribuan adalah 3 (< 5) → dibulatkan ke bawah → Rp20.000. Rp11.500 → angka ribuan adalah 1 (< 5) → Rp10.000. Rp38.200 → angka ribuan adalah 8 (≥ 5) → dibulatkan ke atas → Rp40.000. Total estimasi = Rp70.000.'
            }
        ]
    },
    ...
    refleksi: {
        ...
        instruction: 'Luangkan waktu untuk merenungkan pengalamanmu. Tidak ada jawaban benar atau salah. Jawab setidaknya 3 pertanyaan untuk melanjutkan.',
        questions: [
            {
                id: 'r1',
                label: 'Strategi Estimasiku',
                prompt: 'Saat melakukan estimasi tadi, kamu cenderung membulatkan ke atas, ke bawah, atau campuran? Mengapa kamu memilih strategi itu?',
                placeholder: 'Contoh: Saya cenderung membulatkan ke atas supaya lebih aman, karena saya tidak mau kekurangan uang di kasir...'
            },
            {
                id: 'r2',
                label: 'Akurasi Estimasiku',
                prompt: 'Seberapa dekat estimasimu dengan total sebenarnya? Apa yang menurutmu membuat estimasimu lebih akurat atau kurang akurat?',
                placeholder: 'Contoh: Estimasi saya cukup dekat saat menggunakan pembulatan ke ribuan, tetapi meleset jauh saat ke sepuluh ribuan...'
            },
            {
                id: 'r3',
                label: 'Manfaat Estimasi dalam Kehidupan',
                prompt: 'Dalam situasi apa dalam kehidupan sehari-hari kamu merasa estimasi lebih berguna daripada menghitung persis?',
                placeholder: 'Contoh: Saat belanja di pasar tanpa kalkulator, atau saat antri panjang di kasir dan ingin tahu apakah uangku cukup...'
            },
            {
                id: 'r4',
                label: 'Kesimpulanku',
                prompt: 'Apa yang kamu pelajari tentang hubungan antara estimasi, pembulatan, dan keputusan keuangan sehari-hari?',
